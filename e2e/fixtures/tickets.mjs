...
/** GET /user/payment-config — 카드·쿠폰·차량·포인트 통합 조회 (pay 계약) */
  ...
  coupons: [
    {
      ...
      name: '신규가입 할인',
      pricingType: 'STATIC',
      usageStartAt: '2026-01-01 00:00:00',
      usageEndAt: '2026-12-31 23:59:59',
      couponPrice: 2000
    },
    {
      couponUserId: 502,
  ...
  cars: [
    {
      ...
      comment: null,
      isDefault: true,
      isAgreeAutopay: false,
      isAgreeEnterCarAlarm: false
    }
  ],
  point: {
    generalAmount: 1500,
    voucherAmount: 0,
    expireScheduledAmounts: [],
    totalAmount: 1500,
    isExistHistory: true
  },
  recentPaymentMethod: null,
  recentReceiptEmail: null
}
