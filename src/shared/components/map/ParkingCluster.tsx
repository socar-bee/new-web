  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="absolute top-0 left-1/2 z-[5] -translate-x-1/2">
        <div
          className="bg-brand-700 h-[28px] w-[28px] translate-x-[7px] translate-y-[7px] animate-ping rounded-full opacity-[0.12]"
      ...
      <div className="relative z-[10] flex flex-col items-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="53" viewBox="0 0 48 53" fill="none">
          ...
          <path
            ...
            fill="var(--color-brand-700, #007acc)"
          />
          <path
            ...
            fill="var(--color-brand-800, #006bb3)"
