    ...
    <html lang="ko" suppressHydrationWarning>
      <body>
        <section className="flex h-dvh flex-col items-center justify-center px-6 text-center">
          <h1 className="text-text-strong text-h4 md:text-h3 mb-3 font-bold">일시적인 오류가 발생했습니다</h1>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <Link href="/" className="text-text-sub hover:text-text-strong text-c2 font-medium transition-colors">
              홈으로 돌아가기 →
            </Link>
          </div>
        </section>
